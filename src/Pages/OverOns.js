        ...
        <Persoon
          ...
          text={
            <>
              ...
              lastig het voor collega ICT'ers kan zijn om technische kwesties in
              'normale taal' uit te leggen aan minder technische collega's. Ook
              viel het mij op dat simpele verzoeken van klanten altijd door
              molens van accountmanagers moesten gaan voordat er eindelijk wat
              gebeurde.
              <br />
              ...
              bureaucratie, als u iets wilt dan werken wij dezelfde dag nog aan
              een oplossing. De laagdrempeligheid zorgt ook voor een fijne
        ...
        <Persoon
          ...
          text={
            <>
              ...
              servicedesk medewerker bij Ad Hoc IT services. Vanuit mijn studie
              krijg ik ook dagelijks te maken met de IT echter wel op gebruikers
              niveau. Dit geeft mij een uniek beeld over de wensen van de klant
              en wat er voor nodig is om deze te vervullen.
              <br />
              <br />
